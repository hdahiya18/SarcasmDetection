...
class topic(object):
    def __init__(self,nbtopic=100,alpha=1,model=None,dicttp=None):
        ...
        self.porter = SnowballStemmer("english", ignore_stopwords=True)
        self.alpha = alpha
    ...
    def fit(self,documents):
        ...
        documents_mod = [sr.repGeneral(sr.repEmoti(sentence)) for sentence in documents]
    ...
    def transform(self,sentence):
        ...
        sentence_mod = sr.repGeneral(sr.repEmoti(sentence))
